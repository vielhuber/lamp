...
def main():
    ...
    results = setup(control.configuration(), control.CONFIGURATION / "cloudflare")
...
if __name__ == "__main__":
    try:
        ...
        print(str(error) if not isinstance(error, OSError) else "LAMP filesystem error; check .data/cloudflare permissions.", file=sys.stderr)
        sys.exit(1)
